...
namespace Souqna.Data.Cart
{
    public class ShoppingCart
    {
        ...
        public void RemoveItemFromCart(Product product, bool removeAll)
        {
            var shoppingCartItem = _context.ShoppingCartItems.FirstOrDefault(n => n.Product.ProductId == product.ProductId && n.ShoppingCartId == ShoppingCartId);
        ...
        public double GetShoppingCartTotal() => _context.ShoppingCartItems.Where(n => n.ShoppingCartId == ShoppingCartId).Select(n => n.Product.PriceOfUnit * n.Amount).Sum();
